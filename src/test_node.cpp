...
int main(int argc, char * argv[])
{
    ...
    bool msg_period_bias_flag = false;
    double period_factor = 1.0; // 1.0, 1.2, 1.4, 1.6, 1.8

    int msg_delay_flag = 2; // 0: no delay, 1: delay 1-40 ms, 2: delay 0-upper ms
    ////////////////////////////////////////////////////////////////////////////////////////

    if(msg_delay_flag == 0)
    {
        cout << "Delay flag has been set as 0 !" << endl;
    }
    else if(msg_delay_flag == 1)
    {
        cout << "Delay flag has been set as 1 !" << endl;
    }
    else if(msg_delay_flag == 2)
    {
        cout << "Delay flag has been set as 2 !" << endl;
    }
    ...
    case 2:
    {
        ...
        while(count < TestNum)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic2>(real_period1, real_period2, msg_delay_flag, outfile_lat_, outfile_mdl_, outfile_topic1_, outfile_topic2_);
    ...
    {   
        ...
        while(count < TestNum)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic3>(real_period1, real_period2, real_period3, msg_delay_flag, outfile_lat_, outfile_mdl_, outfile_topic1_, outfile_topic2_, outfile_topic3_);
            executor.add_node(sub_node);
    ...
    case 4:
    {
        ...
        while(count < TestNum)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic4>(real_period1, real_period2, real_period3, real_period4, msg_delay_flag, outfile_lat_, outfile_mdl_, outfile_topic1_, outfile_topic2_, outfile_topic3_, outfile_topic4_);
            executor.add_node(sub_node);
    ...
    case 5:
    {
        ...
        while(count < TestNum)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic5>(real_period1, real_period2, real_period3, real_period4, real_period5, msg_delay_flag, outfile_lat_, outfile_mdl_, outfile_topic1_, outfile_topic2_, outfile_topic3_, outfile_topic4_, outfile_topic5_);
            executor.add_node(sub_node);
    ...
    case 6:
    {
        ...
        while(count < TestNum)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic6>(real_period1, real_period2, real_period3, real_period4, real_period5, real_period6, msg_delay_flag, outfile_lat_, outfile_mdl_, outfile_topic1_, outfile_topic2_, outfile_topic3_, outfile_topic4_, outfile_topic5_, outfile_topic6_);
            executor.add_node(sub_node);
    ...
    case 7:
    {
        ...
        while(count < TestNum)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic7>(real_period1, real_period2, real_period3, real_period4, real_period5, real_period6, real_period7, msg_delay_flag, outfile_lat_, outfile_mdl_, outfile_topic1_, outfile_topic2_, outfile_topic3_, outfile_topic4_, outfile_topic5_, outfile_topic6_, outfile_topic7_);
            executor.add_node(sub_node);
    ...
    case 8:
    {
        ...
        while(count < TestNum)
        {
            ...
            auto sub_node = std::make_shared<SubscriberTopic8>(real_period1, real_period2, real_period3, real_period4, real_period5, real_period6, real_period7, real_period8, msg_delay_flag, outfile_lat_, outfile_mdl_, outfile_topic1_, outfile_topic2_, outfile_topic3_, outfile_topic4_, outfile_topic5_, outfile_topic6_, outfile_topic7_, outfile_topic8_);
            executor.add_node(sub_node);
