    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic2(int period1, int period2, bool msg_delay_flag, std::ofstream& outfile_alg, std::ofstream& outfile_mdl) :
        ...
        msg_delay_flag_(msg_delay_flag), count_alg_(0), count_mdl_(0), delay_previous1_(0), delay_previous2_(0)
    {
    ...
    {
        if(count_alg_ >= PublishedNum)
        {
            return;    
        }
        if(count_alg_ == PublishedNum)
        {
            cout << "Approximate Time Algorithm have got enough 1000 published sets !" << endl;
            if(count_alg_ == PublishedNum && count_mdl_ == PublishedNum)
            {
                count_alg_++;
                kill(getpid(),SIGINT);
            }
    ...
    void mdl_callback(const sensor_msgs::msg::JointState::ConstSharedPtr& msg1, const sensor_msgs::msg::JointState::ConstSharedPtr& msg2)
    {
        ...
        {
            cout << "Approximate Time Model have got enough 1000 published sets !" << endl;
            return;    
        }
        count_mdl_++;
    ...
    void callback1(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        if(delay_previous1_ <= DelayUpper + period1_)
        {
            if(msg_delay_flag_)
            {
                sleep_random_delay(delay_previous1_, period1_);
            }
        }
    ...
    void callback2(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        if(delay_previous2_ <= DelayUpper + period2_)
        {
            if(msg_delay_flag_)
            {
                sleep_random_delay(delay_previous2_, period2_);
            }
        }
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic3(int period1, int period2, int period3, bool msg_delay_flag, std::ofstream& outfile_alg, std::ofstream& outfile_mdl) :
        ...
        msg_delay_flag_(msg_delay_flag), count_alg_(0), count_mdl_(0), delay_previous1_(0.), delay_previous2_(0), delay_previous3_(0),
    ...
    void callback3(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
            if(delay_previous3_ <= DelayUpper + period3_)
            {
                if(msg_delay_flag_)
                {
                    sleep_random_delay(delay_previous3_, period3_);
                }
            }
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic4(int period1, int period2, int period3, int period4, bool msg_delay_flag, std::ofstream& outfile_alg, std::ofstream& outfile_mdl) :
        ...
        msg_delay_flag_(msg_delay_flag), count_alg_(0), count_mdl_(0), 
    ...
    void callback4(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        if(delay_previous4_ <= DelayUpper + period4_)
        {
            if(msg_delay_flag_)
            {
                sleep_random_delay(delay_previous4_, period4_);
            }
        }
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic5(int period1, int period2, int period3, int period4, int period5, bool msg_delay_flag, std::ofstream& outfile_alg, std::ofstream& outfile_mdl) :
    ...
    {       
        if(delay_previous5_ <= DelayUpper + period5_)
        {
            if(msg_delay_flag_)
            {
                sleep_random_delay(delay_previous5_, period5_);
            }
        }
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic6(int period1, int period2, int period3, int period4, int period5, int period6, bool msg_delay_flag, std::ofstream& outfile_alg, std::ofstream& outfile_mdl) :
        ...
        observed_wcp1_(0), observed_wcp2_(0), observed_wcp3_(0), observed_wcp4_(0), observed_wcp5_(0), observed_wcp6_(0)
    {
        ...
        outfile1.open(result_path + "/timestamp1.txt", ios::out);
        if (!outfile1.is_open()) 
        {
            cout<<"Error opening file timestamp1.txt! "<<endl;
        }

        // set output accuracy
        outfile1.setf(ios::fixed, ios::floatfield);
        outfile1.precision(9);

        outfile2.open(result_path + "/timestamp2.txt", ios::out);
        if (!outfile2.is_open()) 
        {
            cout<<"Error opening file timestamp2.txt! "<<endl;
        }
        ...
        outfile3.open(result_path + "/timestamp3.txt", ios::out);
        if (!outfile3.is_open()) 
        {
            cout<<"Error opening file timestamp3.txt! "<<endl;
        }

        // set output accuracy
        outfile3.setf(ios::fixed, ios::floatfield);
        outfile3.precision(9);

        outfile4.open(result_path + "/timestamp4.txt", ios::out);
        if (!outfile4.is_open()) 
        {
            cout<<"Error opening file timestamp4.txt! "<<endl;
        }

        // set output accuracy
        outfile4.setf(ios::fixed, ios::floatfield);
        outfile4.precision(9);

        outfile5.open(result_path + "/timestamp5.txt", ios::out);
        if (!outfile5.is_open()) 
        {
            cout<<"Error opening file timestamp5.txt! "<<endl;
        }

        // set output accuracy
        outfile5.setf(ios::fixed, ios::floatfield);
        outfile5.precision(9);

        outfile6.open(result_path + "/timestamp6.txt", ios::out);
        if (!outfile6.is_open()) 
        {
            cout<<"Error opening file timestamp6.txt! "<<endl;
        }

        // set output accuracy
        outfile6.setf(ios::fixed, ios::floatfield);
        outfile6.precision(9);
    }
    ...
    {       
        ...
        outfile1 << topic1_timestamp << endl;
    ...
    void callback2(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        ...
        outfile2 << topic2_timestamp << endl;
    ...
    void callback3(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        ...
        outfile3 << topic3_timestamp << endl;
    ...
    void callback4(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        ...
        outfile4 << topic4_timestamp << endl;
    ...
    {       
        ...
        outfile5 << topic5_timestamp << endl;
    ...
    void callback6(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        if(delay_previous6_ <= DelayUpper + period6_)
        {
            if(msg_delay_flag_)
            {
                sleep_random_delay(delay_previous6_, period6_);
            }
        }
        ...
        outfile6 << topic6_timestamp << endl;
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic7(int period1, int period2, int period3, int period4, int period5, int period6, int period7, bool msg_delay_flag, std::ofstream& outfile_alg, std::ofstream& outfile_mdl) :
    ...
    void callback7(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        if(delay_previous7_ <= DelayUpper + period7_)
        {
            if(msg_delay_flag_)
            {
                sleep_random_delay(delay_previous7_, period7_);
            }
        }
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic8(int period1, int period2, int period3, int period4, int period5, int period6, int period7, int period8, bool msg_delay_flag, std::ofstream& outfile_alg, std::ofstream& outfile_mdl) :
    ...
    void callback8(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        if(delay_previous8_ <= DelayUpper + period8_)
        {
            if(msg_delay_flag_)
            {
                sleep_random_delay(delay_previous8_, period8_);
            }
        }
    ...
    : public rclcpp::Node
{
    ...
    public:
    SubscriberTopic9(int period1, int period2, int period3, int period4, int period5, int period6, int period7, int period8, int period9, bool msg_delay_flag, std::ofstream& outfile_alg, std::ofstream& outfile_mdl) :
    ...
    void callback9(const sensor_msgs::msg::JointState::ConstSharedPtr msg)
    {
        if(delay_previous9_ <= DelayUpper + period9_)
        {
            if(msg_delay_flag_)
            {
                sleep_random_delay(delay_previous9_, period9_);
            }
        }
